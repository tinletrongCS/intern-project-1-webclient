...
export default {
  ...
  async GetProjectedRevenueRegion(parent, regionId, centerId, departmentId, fromDate, toDate) {
    return await this.getDs(parent, `revenue/ProjectedRevenueRegion/GetProjectedRevenueRegion?regionId=${regionId}&&centerId=${centerId}&&departmentId=${departmentId}&&fromDate=${fromDate}&&toDate=${toDate}`, null, true)
  },
  ...
  async AddProjectedRevenueRegion(parent, data) {
    try {
      parent.loading(true)
      let response = await axios.post('revenue/ProjectedRevenueRegion/AddProjectedRevenueRegion', data)
      parent.loading(false)
      if (response && response.data && response.data.success) {
        return response.data.data
      } else {
  ...
  async DeleteProjectedRevenueRegion(parent, arrId) {
    try {
      parent.loading(true)
      let response = await parent.axios.delete('revenue/ProjectedRevenueRegion/DeleteProjectedRevenueRegion', {
        params: { arrId: arrId }
      })
      parent.loading(false)
      if (response && response.data && response.data.success) {
  ...
  async GetProjectedRevenueRegionInfoById(parent, id) {
    return await this.getDs(parent, `revenue/ProjectedRevenueRegion/GetProjectedRevenueRegionInfoById?id=${id}`, null)
  },

  async UpdateProjectedRevenueRegion(parent, data) {
    try {
      parent.loading(true)
      let response = await axios.post('revenue/ProjectedRevenueRegion/UpdateProjectedRevenueRegion', data)
      parent.loading(false)
      if (response && response.data && response.data.success) {
        return response.data.data
      } else {
  ...
  async GetProjectedRevenueRegionExportExcel(parent, regionId, centerId, departmentId, fromDate, toDate) {
    return await this.getDs(parent, `revenue/ProjectedRevenueRegion/GetProjectedRevenueRegionExportExcel?regionId=${regionId}&&centerId=${centerId}&&departmentId=${departmentId}&&fromDate=${fromDate}&&toDate=${toDate}`, null, true)
  },
    async ImportProjectedRevenueRegion(parent, data){
        try{
            parent.loading(true)
            let response = await axios.post('revenue/ProjectedRevenueRegion/ImportProjectedRevenueRegion',data)
            parent.loading(false)
            if(response && response.data && response.data.success) {
                return response.data.data
            }else{
    ...
    async CheckImportProjectedRevenueRegion(parent, data){
        try{
            parent.loading(true)
            let response = await axios.post('revenue/ProjectedRevenueRegion/CheckImportProjectedRevenueRegion',data)
            parent.loading(false)
            if(response && response.data && response.data.success) {
                return response.data.data
            }else{
