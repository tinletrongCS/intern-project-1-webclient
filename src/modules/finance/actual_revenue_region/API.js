...
export default {
  ...
  async GetActualRevenueRegion(parent, regionId, centerId, departmentId, fromDate, toDate) {
    return await this.getDs(parent, `revenue/ActualRevenueRegion/GetActualRevenueRegion?regionId=${regionId}&&centerId=${centerId}&&departmentId=${departmentId}&&fromDate=${fromDate}&&toDate=${toDate}`, null, true)
  },
  ...
  async AddActualRevenueRegion(parent, data) {
    try {
      parent.loading(true)
      let response = await axios.post('revenue/ActualRevenueRegion/AddActualRevenueRegion', data)
      parent.loading(false)
      if (response && response.data && response.data.success) {
        return response.data.data
      } else {
  ...
  async DeleteActualRevenueRegion(parent, arrId) {
    try {
      parent.loading(true)
      let response = await parent.axios.delete('revenue/ActualRevenueRegion/DeleteActualRevenueRegion', {
        params: { arrId: arrId }
      })
      parent.loading(false)
      if (response && response.data && response.data.success) {
  ...
  async GetActualRevenueRegionInfoById(parent, id) {
    return await this.getDs(parent, `revenue/ActualRevenueRegion/GetActualRevenueRegionInfoById?id=${id}`, null)
  },

  async UpdateActualRevenueRegion(parent, data) {
    try {
      parent.loading(true)
      let response = await axios.post('revenue/ActualRevenueRegion/UpdateActualRevenueRegion', data)
      parent.loading(false)
      if (response && response.data && response.data.success) {
        return response.data.data
      } else {
  ...
  async GetActualRevenueRegionExportExcel(parent, regionId, centerId, departmentId, fromDate, toDate) {
    return await this.getDs(parent, `revenue/ActualRevenueRegion/GetActualRevenueRegionExportExcel?regionId=${regionId}&&centerId=${centerId}&&departmentId=${departmentId}&&fromDate=${fromDate}&&toDate=${toDate}`, null, true)
  },
    async ImportActualRevenueRegion(parent, data){
        try{
            parent.loading(true)
            let response = await axios.post('revenue/ActualRevenueRegion/ImportActualRevenueRegion',data)
            parent.loading(false)
            if(response && response.data && response.data.success) {
                return response.data.data
            }else{
    ...
    async CheckImportActualRevenueRegion(parent, data){
        try{
            parent.loading(true)
            let response = await axios.post('revenue/ActualRevenueRegion/CheckImportActualRevenueRegion',data)
            parent.loading(false)
            if(response && response.data && response.data.success) {
                return response.data.data
            }else{
