<template>
  <div class="main-wrapper">
    ...
    <div class="page-content assignment-kpi-result" style="top: 46px !important; ">
      <div class="box-form">
        <div class="row">
            ...
            <div class="col-sm-6 col-12">
              <div class="info-row">
                  <div class="group-buttons -bottom" style="margin-top: 0px; margin-bottom: 2px;">
                    <button class="btn btn-second" style="min-width: 100px;" @click="onClickUpdateAssignmentResultKPI">
    ...
    <!-- Modal -->
    <UpdateAssignmentKPIResultModal ref="updateAssignmentKPIModal"
...
<script>
import API from './API'
import UpdateAssignmentKPIResultModal from './UpdateAssignmentKPIResultModal.vue'
import moment from 'moment'
export default {
  name:'AssignmentKPIResult',
  components:{
    UpdateAssignmentKPIResultModal
  },
  data(){
    return {
      header: {
  ...
  methods:{
    ...
    onClickUpdateAssignmentResultKPI(){
      ...
      this.$refs.updateAssignmentKPIModal.showModal()
    },
    successAddUpdate(){
      this.initDataGrid()
    },
...
<style>
.assignment-kpi-result .info-row {
    display: table;
    width: 100%;
    table-layout: fixed; /* Bắt buộc table-cell tuân theo width */
}

.assignment-kpi-result .info-row .key {
    white-space: nowrap;
    overflow: hidden;
...
.assignment-kpi-result .info-row .value {
    display: table-cell;
    vertical-align: middle;
...
.assignment-kpi-result .info-row .value .select2-container {
    width: 100% !important;
}

.assignment-kpi-result .info-row .value .select2-selection {
    width: 100% !important;
    overflow: hidden !important;
}

.assignment-kpi-result .info-row .value .select2-selection__rendered {
 ...
 .assignment-kpi-result .col-button-search{
