...
export default {
  ...
  async AddBSCLibrary(parent, data) {
      try {
          parent.loading(true)
          let response = await axios.post('revenue/BSCLibrary/AddBSCLibrary', data)
  ...
  async UpdateBSCLibrary(parent, data) {
      try {
          parent.loading(true)
          let response = await axios.post('revenue/BSCLibrary/UpdateBSCLibrary', data)
          parent.loading(false)
          if (response && response.data && response.data.success) {
              return response.data.data
          } else {
  ...
  async DeleteBSCLibrary(parent, data) {
      try {
          parent.loading(true)
          let response = await axios.post('revenue/BSCLibrary/DeleteBSCLibrary', data)
          parent.loading(false)
          if (response && response.data && response.data.success) {
              return response.data.data
          } else {
