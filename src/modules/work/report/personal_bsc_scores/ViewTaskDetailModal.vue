...
export default {
  ...
  data() {
    return {
      ...
      typeMapping: {
        ...
        tong_duoc_giao: "ĐƯỢC GIAO",

        // --- Rất quan trọng (priority = 3) ---
        rat_quan_trong: "RẤT QUAN TRỌNG HOÀN THÀNH",
        rat_quan_trong_dung_han: "RẤT QUAN TRỌNG HOÀN THÀNH ĐÚNG HẠN",
        rat_quan_trong_hoan_thanh_som_han: "RẤT QUAN TRỌNG HOÀN THÀNH SỚM HẠN",
        rat_quan_trong_hoan_thanh_tre_han: "RẤT QUAN TRỌNG HOÀN THÀNH TRỄ HẠN",

        // --- Hoàn thành theo hạn chung ---
        hoan_thanh_dung_han: "HOÀN THÀNH ĐÚNG HẠN",
        hoan_thanh_som_han: "HOÀN THÀNH SỚM HẠN",
        hoan_thanh_tre_han: "HOÀN THÀNH TRỄ HẠN",

        // --- Bình thường (priority = 1) ---
        binh_thuong_hoan_thanh: "BÌNH THƯỜNG HOÀN THÀNH",
        binh_thuong_hoan_thanh_dung_han: "BÌNH THƯỜNG HOÀN THÀNH ĐÚNG HẠN",
        binh_thuong_hoan_thanh_som_han: "BÌNH THƯỜNG HOÀN THÀNH SỚM HẠN",
        binh_thuong_hoan_thanh_tre_han: "BÌNH THƯỜNG HOÀN THÀNH TRỄ HẠN",

        // --- Quan trọng (priority = 2) ---
        quan_trong_hoan_thanh: "QUAN TRỌNG HOÀN THÀNH",
        quan_trong_hoan_thanh_dung_han: "QUAN TRỌNG HOÀN THÀNH ĐÚNG HẠN",
        quan_trong_hoan_thanh_som_han: "QUAN TRỌNG HOÀN THÀNH SỚM HẠN",
        quan_trong_hoan_thanh_tre_han: "QUAN TRỌNG HOÀN THÀNH TRỄ HẠN",

        //
        tong_cv_chua_hoan_thanh: "CHƯA HOÀN THÀNH",
        tong_cv_chua_hoan_thanh_tre_han: "CHƯA HOÀN THÀNH TRỄ HẠN",

        //
        tong_diem_dinh_muc: "TỔNG ĐIỂM ĐỊNH MỨC",
        tong_diem_chat_luong_cong_viec_hoan_thanh: "CHẤT LƯỢNG CÔNG VIỆC HOÀN THÀNH",
        tong_sao_thuc_hien_khong_hoan_thanh: "THỰC HIỆN KHÔNG HOÀN THÀNH",
        tong_sao_muc_do_binh_thuong: "MỨC ĐỘ BÌNH THƯỜNG",
        tong_sao_muc_do_quan_trong: "MỨC ĐỘ QUAN TRỌNG",
        tong_sao_muc_do_rat_quan_trong: "MỨC ĐỘ RẤT QUAN TRỌNG",
        tong_luot_book_ps: "TỔNG LƯỢT BOOK PS"
      }
  ...
  computed: {
    ...
    DANH SÁCH TỔNG CÔNG VIỆC ${this.typeMapping[this.type_request]} THÁNG ${this.monthViewTitle}`;
    }
  },
  methods: {
    showModal() {
