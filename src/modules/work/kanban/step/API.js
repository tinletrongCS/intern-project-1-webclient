...
export default {
    ...
    async CreateStep(parent, data) {
        try {
            parent.loading(true)
            let response = await axios.post('work/Step/CreateStep', data)
    ...
    async UpdateStep(parent, data) {
        try {
            parent.loading(true)
            let response = await parent.axios.post('work/Step/UpdateStep', data)
            parent.loading(false)
            if (response && response.data && response.data.success) {
                return response.data.data
            } else {
